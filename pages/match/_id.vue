    ...
    <div id="pageMatchDetail" class="compWrapper g-transition">
        ...
        <div class="container-header pb-4 pt-4 mb-1">
            ...
            <v-row class="match-location mr-4 ml-4 mt-2 mb-0">
                <v-chip small color="rgba(255, 255, 255, 0.2)" class="capsule mr-2">Futsal</v-chip>
                <v-chip small color="rgba(255, 255, 255, 0.2)" class="capsule mr-2">Perempuan</v-chip>
            </v-row>
            <v-row class="match-location mr-4 ml-4 mb-2 mt-2">
        ...
        <div class="section-detail-match">
            <v-row class="waktu-main ma-4">
                ...
                <div class="description-wrapper">
                    ...
                    <p class="desc-primary mb-0">18.00 - 20.00 <span class="desc-subdued">(2 jam)</span></p>
                </div>
            </v-row>
            <v-row class="biaya ma-4 pt-2 pb-2">
                ...
                <div class="description-wrapper">
                    ...
                    <p class="desc-primary mb-0"><span class="desc-bold">Rp30.000</span> / pemain</p>
                </div>
            </v-row>
        </div>
        ...
        <div class="section-location ma-4">
            ...
            <p class="desc-primary small">Graha Elnusa Lantai 16, Jl. TB Simatupang Kav. 1 B, RT.10/RW.3</p>
            <!-- maps -->
            <div
                class="mb-6"
            ...
            <v-row class="detail-host ma-0">
                ...
                <div class="description-wrapper">
                    <v-row style="align-item: center;" class="ma-0">
                        <p class="desc-bold mb-0 mr-2" style="align-item: center;">Faishal Arif 
                        </p>
                        <img
                            width="20"
                            height="20"
...
.icon-wrapper {
    background: rgba(227, 242, 253, 1.0);
    border-radius: 50%;
    height: 32px;
    width: 32px;
    padding: 6px;
